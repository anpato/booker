...
export default [
  {
    _id: uuid('5e190adc92477d5902490532'),
    name: 'Sage Rippin',
    profile_img:
      'https://s3.amazonaws.com/uifaces/faces/twitter/adamnac/128.jpg',
    email: 'Bonnie83@yahoo.com',
    business_id: uuid('5e17d52abefd53d9697375d5'),
    isAdmin: true
  },
  {
    _id: uuid('5e190af15f2306f25ccc3dcf'),
    name: 'Ivory Mitchell',
    profile_img:
  ...
  {
    _id: uuid('5e190afb3e57e9a30a5bab62'),
    name: 'Giles Johnson',
    profile_img:
  ...
  {
    _id: uuid('5e190b02e5772f475367dda5'),
